...
YANDEX_AWS_ACCESS_KEY_ID: Final[str] = os.getenv("YANDEX_AWS_ACCESS_KEY_ID")
YANDEX_AWS_ACCESS_KEY_SECRET: Final[str] = os.getenv("YANDEX_AWS_ACCESS_KEY_SECRET")
YANDEX_AWS_DEFAULT_REGION: Final[str] = os.getenv("YANDEX_AWS_DEFAULT_REGION")
YANDEX_IAM_TOKEN: Final[str] = os.getenv("YANDEX_IAM_TOKEN")
YANDEX_FOLDER_ID: Final[str] = os.getenv("YANDEX_FOLDER_ID")
YANDEX_FUNCTION_NAME: Final[str] = os.getenv("YANDEX_FUNCTION_NAME")
YANDEX_BUCKET_NAME: Final[str] = os.getenv("YANDEX_BUCKET_NAME")
