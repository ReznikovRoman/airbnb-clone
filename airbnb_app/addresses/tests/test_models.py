...
class AddressModelTests(TestCase):
    ...
    def test_city_field_params(self):
        """`city` field has all required parameters."""
    ...
    def test_street_field_params(self):
        """`street` field has all required parameters."""
    ...
    def test_object_name_has_object_id(self):
        """Address object name is set up properly."""
