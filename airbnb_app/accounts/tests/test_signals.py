...
class AccountsSignalsTests(TestCase):
    ...
    def test_handle_user_sign_up_new_user_has_common_group(self):
        """Test that all new Users are in a `common` Group."""
    ...
    def test_handle_user_sign_up_profile_for_new_user_is_created(self):
        """Test that Profile is created for all new Users."""
    ...
    def test_handle_user_sign_up_update_user_field_in_subscriber_object(self):
        """Test that if there is a Subscriber with `new user email` - Subscriber's `user` field will be updated."""
    ...
    def test_update_profile_new_subscriber_email(self):
        """Test that if User changes an email and User was a Subscriber, Subscriber's email will be also changed."""
